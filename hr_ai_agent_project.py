...
rag_prompt = ChatPromptTemplate.from_messages([
    ("system", "You are an HR executive writing professional, helpful email replies. Only generate the response body – do not include a subject line or headers."),
...
full_chain = (
    ...
    | RunnableBranch(
        (lambda x: x["category"] == "leave_request", get_rag_chain()),
